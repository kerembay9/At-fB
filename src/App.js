...
function App() {
  ...
  const [publicationList, setPublicationList] = useState(()=>{return [
    {
      id: 1,
      title:"Bayramoğlu, A., Sever, M., Uzun, N., Ceritli, S., & Mutlu, H.      (2020). Hyponatremia in COVID- 19 patient using angiotensin type 1 receptor (AT1R) blocker and diuretic: a case report. J Res Clin Med, 8(1). ",
    ...
    { 
      id: 2,
      title:"Bayramoglu, A., Kocak, A. O., & Kadioglu, E. (2018). Ischemic stroke due to carbon monoxide intoxication: Two case reports. World Journal of Emergency Medicine, 9(1), 73.",
    ...
    { 
      id: 3,
      title:"Bayramoğlu, A., & Kurt, E. (2018). The size of the study      population: Correspondance related “Measurement of blood lactate, D-dimer, and activated prothrombin time improves prediction of in-hospital mortality in adults blunt trauma”. The American Journal of Emergency Medicine, 36(12), 2334-2335.",
